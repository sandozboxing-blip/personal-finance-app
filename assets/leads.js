...
function openLeadFilterMenu(){var menu=document.getElementById('leadFilterMenu'),backdrop=document.getElementById('leadFilterBackdrop');if(!menu)return;menu.classList.add('open');if(backdrop)backdrop.classList.add('open');document.body.classList.add('lead-filter-open');var close=menu.querySelector('.filterclose');if(close)setTimeout(function(){close.focus();},30);}
function closeLeadFilterMenu(){var menu=document.getElementById('leadFilterMenu'),backdrop=document.getElementById('leadFilterBackdrop');if(menu)menu.classList.remove('open');if(backdrop)backdrop.classList.remove('open');document.body.classList.remove('lead-filter-open');}
