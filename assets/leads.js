...
function closeLeadOutreach(){var ov=document.getElementById('leadOutreachOv');if(ov)ov.classList.remove('open');document.body.classList.remove('outreach-open');}
