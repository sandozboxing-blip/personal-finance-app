...
function toggleWebPayment(){var monthly=(document.getElementById('fcpayment')||{}).value!=='one_time',m=document.getElementById('webMonthlyFields'),o=document.getElementById('webOneFields'),l=document.getElementById('webCostLabel');if(m)m.style.display=monthly?'':'none';if(o)o.style.display=monthly?'none':'';var ip=document.getElementById('fcinitialpaidrow'),op=document.getElementById('fconetimepaidrow'),pt=document.getElementById('fcpaidthrough');if(ip)ip.style.display=monthly?'flex':'none';if(op)op.style.display=monthly?'none':'flex';if(pt&&pt.parentElement)pt.parentElement.style.display=monthly?'':'none';if(l)l.textContent=monthly?'Месечни разходи (€)':'Разходи за проекта (€)';calcWeb();}
...
function saveClient() {
  ...
  if (edittype === 'smm') {
    ...
    var obj = {
      ...
      platforms: plats,
      paidThrough: (document.getElementById('fcpaidthrough') || {}).value || ''
    };
    ...
    var obj = {
      ...
      note: (document.getElementById('fcnote') || {}).value || '',
      paidThrough: (document.getElementById('fcpaidthrough') || {}).value || '',
      initialPaid: !!(document.getElementById('fcinitialpaid') || {}).checked,
      oneTimePaid: !!(document.getElementById('fconetimepaid') || {}).checked
    };
