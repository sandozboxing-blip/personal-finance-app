...
Brave is detected automatically from its standard Windows installation folders. If it is installed elsewhere, add `"bravePath": "C:\\path\\to\\brave.exe"` to `config.local.json`.
